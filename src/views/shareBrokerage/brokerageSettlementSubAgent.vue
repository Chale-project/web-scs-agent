<template>
  <div style="background:#fff ;padding:25px;position: relative">
    ...
    <!-- 新增编辑模态框 -->
    <a-modal width="800px" :title="modalTitle" :visible="visible" @ok="handleOk" :confirmLoading="confirmLoading" @cancel="handleCancel">
...
import { getBrokerageSettlementListSubAgent } from '@/api/common'
...
export default {
  name: 'brokerageSettlementSubAgent',
  components: {
    Pagination,
    DetailList,
    DetailListItem
  ...
  methods: {
    ...
    getBrokerageSettlementList() {
      ...
      getBrokerageSettlementListSubAgent(_data)
        .then(res => {
          this.loading = !1
          if (res.code == 0) {
