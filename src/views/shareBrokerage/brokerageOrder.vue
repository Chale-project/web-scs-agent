    ...
    <a-modal :width="editType=='detail'?'800px':'400px'" :title="modalTitle" :visible="visible" @ok="handleOk" :confirmLoading="confirmLoading" @cancel="handleCancel">
      ...
      <div class="modal-container" v-else>
        ...
        <detail-list title="分佣信息">
          ...
          <detail-list-item term="我的佣金">{{brokerageOrderInfo.selfAgentCommission}}</detail-list-item>
          <detail-list-item term="下级代理佣金">{{brokerageOrderInfo.downAgentCommission}}</detail-list-item>
...
import { getBrokerageOrderList, correctBrokerageOrder } from '@/api/common'
...
const columns = [
  ...
  },
  {
    title: '我的佣金',
    align: 'center',
    dataIndex: 'selfAgentCommission'
  },
  {
    title: '下级代理佣金',
    align: 'center',
    dataIndex: 'downAgentCommission'
  },
  {
    title: '结算状态',
    align: 'center',
