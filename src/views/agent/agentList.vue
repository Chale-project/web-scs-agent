      ...
      <a-form layout="inline">
        <a-row :gutter="48">
          ...
          <template v-if="advanced">
            <a-col :md="8" :sm="24">
              <a-form-item label="代理商级别">
                <a-select placeholder="请选择" v-model="queryParam.grade">
                  ...
                  <template v-if="agentInfo.grade=='one'">
                    <a-select-option value="two">二级代理商</a-select-option>
                    <a-select-option value="three">三级代理商</a-select-option>
                  </template>
                  <template v-else-if="agentInfo.grade=='two'">
                    <a-select-option value="three">三级代理商</a-select-option>
                  </template>
                  <template v-else-if="agentInfo.grade==undefined">
                    <a-select-option value="one">一级代理商</a-select-option>
                    <a-select-option value="two">二级代理商</a-select-option>
                    <a-select-option value="three">三级代理商</a-select-option>
                  </template>
            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="代理商手机号">
                <a-input v-model="queryParam.linkmanPhoneNumber" placeholder="请输入代理商手机号" />
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
          ...
          <a-row :gutter="24">
            <a-col :md="12" :sm="24">
              <a-form-item label="代理商级别" :required="true">
                <a-radio-group v-model="forms.grade" :disabled="editType=='edit'||editType=='detail'">
                  <template v-if="agentInfo.grade=='one'">
  ...
  methods: {
    ...
    handleAgent(e, o, i) {
      ...
      if (this.editType == 'add') {
        ...
        this.visible = !0
        this.forms = {
          grade: this.agentInfo.grade == 'one' ? 'two' : this.agentInfo.grade == 'two' ? 'three' : 'one',
          agentName: null,
          linkmanName: null,
          linkmanPhoneNumber: null,
          salesmanId: null,
