<template>
  <div style="background:#fff ;padding:25px;position: relative">
    ...
    <a-modal :width="editType=='add'?'800px':editType=='edit'?'800px':editType=='detail'?'800px':'400px'" :title="modalTitle" :visible="visible" @ok="handleOk" :confirmLoading="confirmLoading" @cancel="handleCancel">
      ...
      <p v-else-if="editType=='pass'">确认审核通过所选业务员？</p>
          ...
          <a-row :gutter="24">
            ...
            <a-col :md="12" :sm="24">
              <a-form-item label="结算方式" :required="true">
                <a-radio-group v-model="forms.accountChannel" :disabled="editType=='detail'" @change="onChangeAccountChannel">
            ...
            <template v-if="forms.accountChannel=='card'">
              <a-col :md="12" :sm="24">
                <a-form-item label="开户行" :required="true">
                  <a-select v-model="forms.bankName" :disabled="editType=='detail'" placeholder="请选择">
              ...
              <a-col :md="12" :sm="24">
                <a-form-item label="开户支行" :required="true">
                  <a-input v-model="forms.bankAddress" :disabled="editType=='detail'" placeholder="请输入开户支行" />
                </a-form-item>
              </a-col>
            </template>
            <a-col :md="12" :sm="24">
              <a-form-item :label="forms.accountChannel=='card'?'银行卡账号':forms.accountChannel=='alipay'?'支付宝账号':forms.accountChannel=='wechat'?'微信账号':forms.accountChannel=='qq'?'QQ账号':''" :required="true">
                <a-input v-model="forms.accountNumber" :disabled="editType=='detail'" :placeholder="forms.accountChannel=='card'?'请输入银行卡号':forms.accountChannel=='alipay'?'请输入支付宝账号':forms.accountChannel=='wechat'?'请输入微信账号':forms.accountChannel=='qq'?'请输入QQ号':'请输入'" />
              </a-form-item>
            </a-col>
            <a-col :md="12" :sm="24">
              <a-form-item :label="forms.accountChannel=='card'?'账号姓名':forms.accountChannel=='alipay'?'支付宝昵称':forms.accountChannel=='wechat'?'微信昵称':forms.accountChannel=='qq'?'QQ昵称':''" :required="true">
                <a-input v-model="forms.accountName" :disabled="editType=='detail'" :placeholder="forms.accountChannel=='card'?'请输入账号姓名':forms.accountChannel=='alipay'?'请输入支付宝昵称':forms.accountChannel=='wechat'?'请输入微信昵称':forms.accountChannel=='qq'?'请输入QQ昵称':'请输入'" />
              </a-form-item>
            </a-col>
