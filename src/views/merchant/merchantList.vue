<template>
  <div style="background:#fff ;padding:25px;position: relative">
        ...
        <a-row :gutter="48">
          <a-col :md="8" :sm="24">
            <a-form-item label="商户名称">
              <a-input v-model="queryParam.merchantName" placeholder="商户名称" />
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
            <a-form-item label="联系电话">
              <a-input v-model="queryParam.phoneNumber" placeholder="联系电话" />
            </a-form-item>
          </a-col>
    ...
    <div class="table-operator">
      <!-- <a-button type="primary" icon="plus" @click="handleMerchant('add')">添加</a-button> -->
      <a-button type="primary" icon="edit" @click="handleMerchant('edit')">编辑</a-button>
      <!-- <a-button type="primary" icon="check-circle" @click="handleMerchant('pass')">通过审核</a-button>
      <a-button type="primary" icon="stop" @click="handleMerchant('notpass')">不通过审核</a-button>
      <a-button type="primary" icon="delete" @click="handleMerchant('delete')">删除</a-button>
      <a-dropdown v-if="selectedRowKeys.length > 0">
        <a-menu slot="overlay">
          <a-menu-item key="1" @click="handleMerchant('enabled')">
            <a-icon type="unlock" />启用
          </a-menu-item>
          <a-menu-item key="2" @click="handleMerchant('disabled')">
            <a-icon type="lock" />禁用
          </a-menu-item>
        </a-menu>
    ...
    <a-modal :width="editType=='add'?'800px':editType=='edit'?'800px':editType=='detail'?'800px':'400px'" :title="modalTitle" :visible="visible" @ok="handleOk" :confirmLoading="confirmLoading" @cancel="handleCancel">
      ...
      <!-- <p v-else-if="editType=='pass'">确认通过所选商户？</p>
      <p v-else-if="editType=='notpass'">确认不通过所选商户？</p>
      <p v-else-if="editType=='enabled'">确认启用所选商户？</p>
      <p v-else-if="editType=='disabled'">确认禁用所选商户？</p> -->
        ...
        <a-form>
          <a-row :gutter="24">
            ...
            <a-col :md="12" :sm="24" v-show="editType=='detail'">
              <a-form-item label="操作状态">
                <a-select v-model="forms.operationState" :disabled="editType=='detail'" placeholder="请选择">
                  <a-select-option value="yes">启用</a-select-option>
                  <a-select-option value="not">禁用</a-select-option>
                </a-select>
              </a-form-item>
            ...
            <!-- <a-col :md="12" :sm="24" v-show="editType=='detail'">
              <a-form-item label="审核状态">
                <a-select v-model="forms.auditState" :disabled="editType=='detail'" placeholder="请选择">
                  <a-select-option value="pass">通过</a-select-option>
                  <a-select-option value="notpass">不通过</a-select-option>
                </a-select>
              </a-form-item>
            ...
            <a-col :md="12" :sm="24">
              <a-form-item label="收呗支付商户号" :required="true">
                <a-input v-model="forms.mchNo" :disabled="editType=='detail'" placeholder="请输入收呗支付商户号" />
              </a-form-item>
            </a-col>
            <a-col :md="12" :sm="24">
